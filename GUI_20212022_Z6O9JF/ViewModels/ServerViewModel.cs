    ...
    public class ServerViewModel : ObservableRecipient
    {
        ...
        public ServerViewModel(IClientLogic clientLogic)
        {
            ...
            StartCommand = new RelayCommand(() =>
            {
                ...
                {
                    clientLogic.StartServer(turnLength: 240, clients: ClientNumber, map: Map, ip: IP);
                }
                else
                {
                    ;
                    ...
                    ;
                    clientLogic.LoadGame(save: save, turnLength: 240, clients: ClientNumber, map: Map, ip: IP);
                }
            });
        }
    }
